  ...
  return (
    <View {...props} style={styles.tabListContainer}>
      <ThemedView type="backgroundElement" style={styles.innerContainer}>
        <ThemedText type="smallBold" style={styles.brandText}>LINKUP</ThemedText>
        {props.children}
        <ThemedText type="small" themeColor="textSecondary" style={styles.footerText}>Private by design</ThemedText>
      </ThemedView>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  brandText: { marginRight: 'auto', letterSpacing: 2 },
  footerText: { marginLeft: 'auto' },
  pressed: { opacity: 0.7 },
